...
namespace OdataToEntity.AspNetCore
{
    public sealed class ODataPrimitiveResult<T> : ODataResult<T>
    {
        ...
        {
            await Parsers.OePostParser.WriteCollectionAsync(_edmModel, _odataUri, (IAsyncEnumerator<Object>)_items, context.HttpContext.Response.Body).ConfigureAwait(false);
        }
    }
}
