...
namespace OdataToEntity.Test.AspMvcServer.Controllers
{
    ...
    public sealed class CustomersController
    {
        ...
        [HttpGet("[controller]/BoundFunctionCollection(orderNames={orderNames})", Order = 1)]
        ...
        [HttpGet("[controller]({country},{id})/OdataToEntity.Test.Model.BoundFunctionSingle(orderNames={orderNames})")]
        ...
        [HttpGet("[controller]({country},{id})", Order = 2)]
